# --------------------------------------------------------
# Depth estimation config for Vision Mamba Tiny (24 layers)
# Dataset: NYU Depth v2
# Input size: 512x512, sliding mode with stride (341, 341)
...
model = dict(
    backbone=dict(
        ...
        pretrained=None,
        rms_norm=False,  # Use LayerNorm for CPU compatibility
        residual_in_fp32=False,
        fused_add_norm=False,  # Disable fused ops for CPU training
