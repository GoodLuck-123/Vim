...
def parse_args():
    parser = argparse.ArgumentParser(
        description='test depth estimation model')
    ...
    parser.add_argument('--local-rank', type=int, default=0, dest='local_rank')  # For torch.distributed.launch
...
def main():
    ...
    # For depth models, we don't use CLASSES/PALETTE attributes
    # They are only relevant for segmentation models
    ...
    # For depth models, we don't support cityscapes-specific formatting
    if args.format_only:
